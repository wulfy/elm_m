...
ob_start();
?>
<button itemprop="availability" content="in_stock" id="wpshop_add_to_cart_{WPSHOP_PRODUCT_ID}" class="waves-effect waves-light btn wpshop_add_to_cart_button wps-bton-first-mini-rounded"><i class="wps-icon-basket"></i><?php _e('Add to cart', 'wpshop'); ?></button> 
<button itemprop="availability" content="in_stock" type="button" id="wpshop_ask_a_quotation_{WPSHOP_PRODUCT_ID}" class="waves-effect waves-light btn bton_bleu wpshop_ask_a_quotation_button wpshop_products_listing_bton_panier_active">Demander un devis</button>
